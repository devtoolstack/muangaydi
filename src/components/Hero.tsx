        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-gradient-to-r from-brand-primary to-brand-secondary text-white px-10 py-5 rounded-2xl font-black text-lg flex items-center gap-2 hover:opacity-90 transition-all group active:scale-95 shadow-2xl shadow-brand-primary/20 uppercase tracking-tight cursor-pointer">
                Xem Deal HOT nhất <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="bg-white/10 backdrop-blur-xl border border-white/20 text-white px-10 py-5 rounded-2xl font-black text-lg hover:bg-white/20 transition-all active:scale-95 uppercase tracking-tight cursor-pointer">
                Voucher hôm nay
              </button>
            </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative z-10 rounded-5xl overflow-hidden glass shadow-2xl shadow-brand-primary/10 rotate-3 transition-transform hover:rotate-0 duration-500 border border-white/20">
              <img 
